...
1. Start implementation of new feature by create an issue
   - The Owner of the project will assign someone on the feature to dev it
   - Create new branch and checkout to work on
   - Make a Pull Request when u want push on production
